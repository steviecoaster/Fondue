...
@{
    ...
    GUID              = '20f7494c-ab60-4780-b9d6-5a9abc894075'
    ...
    AliasesToExport   = @('New-VirtualPackage')
    ...
    PrivateData       = @{
        ...
        PSData = @{
            ...
            ProjectUri                 = 'https://github.com/steviecoaster/Fondue'
            ...
            ExternalModuleDependencies = @(@{ ModuleName = 'Pester'; ModuleVersion = '5.0.0' })
